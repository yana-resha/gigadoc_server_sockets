...
const DEVIATION_COUNT_BY_MEASUREMENT = {
  heart_and_vessels: 2,
  skin: 1,
  vision: 1,
};
...
const buildResultsIntro = (completedMeasurements) =>
  MEASUREMENT_PLAN.map((type) => {
    ...
    return {
      type,
      completed,
      deviations_count: completed ? DEVIATION_COUNT_BY_MEASUREMENT[type] : 0,
    };
  });
...
const attribute = (name, indicator, value, unit = null, details = {}) => ({
  name,
  indicator,
  type: Array.isArray(value) ? "number[]" : typeof value,
  value,
  unit,
  ...details,
});

const rangeSteps = (steps) => steps.map(([from, to, status]) => ({ from, to, status }));
      ...
      zones: [
        zone("fpg", "Зона фотоплетизмографии", heartCompleted, [
          createCompletedCheckup(
            ...
            [
              ...
              attribute("Уровень стресса", "stress", 650, null, {
                status: "problem",
                step_values: rangeSteps([
                  [0, 150, "normal"],
                  [150, 500, "deviation"],
        ...
        zone("cardio", "Зона кардио", heartCompleted, [
          createCompletedCheckup(
            ...
            "Кардиокарта",
            [
              attribute("ЧСС", "heart_rate", 108, "уд/мин", {
                status: "problem",
                step_values: rangeSteps([
                  [0, 40, "problem"],
                  [40, 60, "deviation"],
              ...
              attribute("Интервал QTc", "qtc", 465, "мс", {
                status: "deviation",
                step_values: rangeSteps([
                  [0, 450, "normal"],
                  [450, 480, "deviation"],
        ...
        zone("derm", "Зона кожи", skinCompleted, [
          createCompletedCheckup(
            ...
            "Кожа",
            [
              attribute("Жирный блеск", "greasy_shine", 1.5, null, {
                status: "normal",
                step_values: rangeSteps([
                  [0, 2, "normal"],
                  [3, 5, "deviation"],
              ...
              attribute("Покраснение", "redness", 9.5, null, {
                status: "serious",
                step_values: rangeSteps([
                  [0, 2, "normal"],
                  [3, 5, "deviation"],
        ...
        zone("vision", "Зона зрения", visionCompleted, [
          createCompletedCheckup(
            ...
            [
              attribute("Острота левого глаза", "leftEyeAcuity", 0.8, null, {
                status: "deviation",
                step_values: rangeSteps([
                  [0.1, 0.7, "problem"],
                  [0.7, 0.9, "deviation"],
              ...
              attribute("Острота правого глаза", "rightEyeAcuity", 1, null, {
                status: "normal",
                step_values: rangeSteps([
                  [0.1, 0.7, "problem"],
                  [0.7, 0.9, "deviation"],
